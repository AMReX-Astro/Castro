...
! ::: level     => refinement level of this array
! ::: -----------------------------------------------------------
      subroutine ca_enterror(tag,tagl1,tagh1, &
                             set,clear, &
                             ent,entl1,enth1, &
                             lo,hi,nd,domlo,domhi, &
                             delta,xlo,problo,time,level)
      ...
      integer lo(1), hi(1), domlo(1), domhi(1)
      integer tag(tagl1:tagh1)
      double precision ent(entl1:enth1,nd)
      double precision delta(1), xlo(1), problo(1), time
...
!     Tag on regions of high entropy gradient
      if (level .lt. max_entgrad_lev) then
         do i = lo(1), hi(1)
            ax = ABS(ent(i+1,1) - ent(i,1))
            ax = MAX(ax,ABS(ent(i,1) - ent(i-1,1)))
...
! ::: level     => refinement level of this array
! ::: -----------------------------------------------------------
      subroutine ca_yeerror(tag,tagl1,tagh1, &
                             set,clear, &
                             ye,yel1,yeh1, &
                             lo,hi,nd,domlo,domhi, &
                             delta,xlo,problo,time,level)
      ...
      integer lo(1), hi(1), domlo(1), domhi(1)
      integer tag(tagl1:tagh1)
      double precision ye(yel1:yeh1,nd)
      double precision delta(1), xlo(1), problo(1), time
...
!     Tag on regions of high ye gradient
      if (level .lt. max_yegrad_lev) then
         do i = lo(1), hi(1)
            ax = ABS(ye(i+1,1) - ye(i,1))
            ax = MAX(ax,ABS(ye(i,1) - ye(i-1,1)))
...
! ::: level     => refinement level of this array
! ::: -----------------------------------------------------------
      subroutine ca_graverror(tag,tagl1,tagh1, &
                             set,clear, &
                             grav,gravl1,gravh1, &
                             lo,hi,nd,domlo,domhi, &
                             delta,xlo,problo,time,level)
      ...
      integer set, clear, nd, level
      integer tagl1,tagh1
      integer gravl1,gravh1
      integer lo(1), hi(1), domlo(1), domhi(1)
      integer tag(tagl1:tagh1)
      double precision grav(gravl1:gravh1,nd)
      double precision delta(1), xlo(1), problo(1), time
