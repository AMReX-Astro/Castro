subroutine set_castro_method_params( &
  ...
  dtnuc_f1_in, dtnuc_f2_in, react_T_min_in,  &
  ...
  double precision, intent(in) :: dtnuc_f1_in
  double precision, intent(in) :: dtnuc_f2_in
  ...
  dtnuc_f1 = dtnuc_f1_in
  dtnuc_f2 = dtnuc_f2_in
