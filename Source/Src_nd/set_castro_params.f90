subroutine set_castro_method_params( &
  ...
  small_pres_in, small_ener_in, do_grav_in,  &
  do_rotation_in, do_acc_in, rot_period_in,  &
  rot_period_dot_in, rot_source_type_in, rot_axis_in,  &
  deterministic_in, normalize_species_in, fix_mass_flux_in,  &
  allow_negative_energy_in, ppm_type_in, ppm_reference_in,  &
  ...
  grav_source_type_in, do_sponge_in)
