...
#ifdef TAU
    react_half_dt(S_new,reactions_new,tau_diff,interior_mask_second_half,cur_time,dt,react_ngrow_second_half);
#else
    react_half_dt(S_new,reactions_new,interior_mask_second_half,cur_time,dt,react_ngrow_second_half);
#endif
