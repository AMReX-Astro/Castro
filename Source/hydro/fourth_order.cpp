...
void Castro::fourth_interfaces(const Box& bx, const int idir, const int ncomp,
    ...
    if (idir == 0) {
        ...
        amrex::ParallelFor(bx, [=] AMREX_GPU_HOST_DEVICE(int i, int j,
            ...
            if (i == domlo[0] + 1 && lo_bc[0] != Interior) {
                ...
                a_int(i, j, k) =
                    (1.0_rt / 12.0_rt) *
                    (3.0_rt * a(i - 1, j, k, ncomp) +
                     13.0_rt * a(i, j, k, ncomp) -
                ...
                a_int(i, j, k) =
                    (1.0_rt / 12.0_rt) * (25.0_rt * a(i, j, k, ncomp) -
                                          23.0_rt * a(i + 1, j, k, ncomp) +
                                          13.0_rt * a(i + 2, j, k, ncomp) -
                                          3.0_rt * a(i + 3, j, k, ncomp));
                ...
                a_int(i, j, k) =
                    (1.0_rt / 12.0_rt) *
                    (3.0_rt * a(i, j, k, ncomp) +
                     13.0_rt * a(i - 1, j, k, ncomp) -
                ...
                a_int(i, j, k) =
                    (1.0_rt / 12.0_rt) * (25.0_rt * a(i - 1, j, k, ncomp) -
                                          23.0_rt * a(i - 2, j, k, ncomp) +
                                          13.0_rt * a(i - 3, j, k, ncomp) -
                                          3.0_rt * a(i - 4, j, k, ncomp));

            } else if (i == domlo[0] - 1 && lo_bc[0] == Outflow) {
                // extrapolate to the domlo[0]-1 cell using a
                // conservative cubic polynomial averaged over
                // the cell
                Real ac = 4.0_rt * a(domlo[0], j, k, ncomp) -
                          6.0_rt * a(domlo[0] + 1, j, k, ncomp) +
                          4.0_rt * a(domlo[0] + 2, j, k, ncomp) -
                          a(domlo[0] + 3, j, k, ncomp);

                // now use the 1-sided stencil from above with
                // this extrapolated value
                a_int(i, j, k) =
                    (1.0_rt / 12.0_rt) *
                    (25.0_rt * ac - 23.0_rt * a(i + 1, j, k, ncomp) +
                     13.0_rt * a(i + 2, j, k, ncomp) -
                     3.0_rt * a(i + 3, j, k, ncomp));
                ...
                // conservative cubic polynomial averaged over
                // the cell
                Real ac = 4.0_rt * a(domhi[0], j, k, ncomp) -
                          6.0_rt * a(domhi[0] - 1, j, k, ncomp) +
                          4.0_rt * a(domhi[0] - 2, j, k, ncomp) -
                          a(domhi[0] - 3, j, k, ncomp);

                // now use the 1-sided stencil from above with
                // this extrapolated value
                a_int(i, j, k) =
                    (1.0_rt / 12.0_rt) *
                    (25.0_rt * ac - 23.0_rt * a(i - 2, j, k, ncomp) +
                     13.0_rt * a(i - 3, j, k, ncomp) -
                     3.0_rt * a(i - 4, j, k, ncomp));
                ...
                a_int(i, j, k) =
                    (7.0_rt / 12.0_rt) *
                        (a(i - 1, j, k, ncomp) + a(i, j, k, ncomp)) -
                    (1.0_rt / 12.0_rt) *
                        (a(i - 2, j, k, ncomp) + a(i + 1, j, k, ncomp));
            }
        });
        ...
        amrex::ParallelFor(
            bx, [=] AMREX_GPU_HOST_DEVICE(int i, int j, int k) noexcept {
                ...
                if (j == domlo[1] + 1 && lo_bc[1] != Interior) {
                    ...
                    // from the left physical boundary, MC Eq. 22
                    a_int(i, j, k) =
                        (1.0_rt / 12.0_rt) * (3.0_rt * a(i, j - 1, k, ncomp) +
                                              13.0_rt * a(i, j, k, ncomp) -
                                              5.0_rt * a(i, j + 1, k, ncomp) +
                                              a(i, j + 2, k, ncomp));
                    ...
                    a_int(i, j, k) =
                        (1.0_rt / 12.0_rt) * (25.0_rt * a(i, j, k, ncomp) -
                                              23.0_rt * a(i, j + 1, k, ncomp) +
                                              13.0_rt * a(i, j + 2, k, ncomp) -
                                              3.0_rt * a(i, j + 3, k, ncomp));

                } else if (j == domhi[1] && hi_bc[1] != Interior) {
                    // use a stencil for the interface that is one zone
                    // from the right physical boundary, MC Eq. 22
                    a_int(i, j, k) =
                        (1.0_rt / 12.0_rt) * (3.0_rt * a(i, j, k, ncomp) +
                                              13.0_rt * a(i, j - 1, k, ncomp) -
                                              5.0_rt * a(i, j - 2, k, ncomp) +
                                              a(i, j - 3, k, ncomp));
                    ...
                    // right physical boundary MC Eq. 21
                    a_int(i, j, k) =
                        (1.0_rt / 12.0_rt) * (25.0_rt * a(i, j - 1, k, ncomp) -
                                              23.0_rt * a(i, j - 2, k, ncomp) +
                                              13.0_rt * a(i, j - 3, k, ncomp) -
                                              3.0_rt * a(i, j - 4, k, ncomp));

                } else if (j == domlo[1] - 1 && lo_bc[1] == Outflow) {
                    // extrapolate to the domlo[1]-1 cell using a
                    // conservative cubic polynomial averaged over
                    // the cell
                    Real ac = 4.0_rt * a(i, domlo[1], k, ncomp) -
                              6.0_rt * a(i, domlo[1] + 1, k, ncomp) +
                              4.0_rt * a(i, domlo[1] + 2, k, ncomp) -
                              a(i, domlo[1] + 3, k, ncomp);

                    // now use the 1-sided stencil from above with
                    // this extrapolated value
                    a_int(i, j, k) =
                        (1.0_rt / 12.0_rt) *
                        (25.0_rt * ac - 23.0_rt * a(i, j + 1, k, ncomp) +
                         13.0_rt * a(i, j + 2, k, ncomp) -
                         3.0_rt * a(i, j + 3, k, ncomp));
                    ...
                    // conservative cubic polynomial averaged over
                    // the cell
                    Real ac = 4.0_rt * a(i, domhi[1], k, ncomp) -
                              6.0_rt * a(i, domhi[1] - 1, k, ncomp) +
                              4.0_rt * a(i, domhi[1] - 2, k, ncomp) -
                              a(i, domhi[1] - 3, k, ncomp);

                    // now use the 1-sided stencil from above with
                    // this extrapolated value
                    a_int(i, j, k) =
                        (1.0_rt / 12.0_rt) *
                        (25.0_rt * ac - 23.0_rt * a(i, j - 2, k, ncomp) +
                         13.0_rt * a(i, j - 3, k, ncomp) -
                         3.0_rt * a(i, j - 4, k, ncomp));
                    ...
                    a_int(i, j, k) =
                        (7.0_rt / 12.0_rt) *
                            (a(i, j - 1, k, ncomp) + a(i, j, k, ncomp)) -
                        (1.0_rt / 12.0_rt) *
                            (a(i, j - 2, k, ncomp) + a(i, j + 1, k, ncomp));
                }
            });
        ...
        amrex::ParallelFor(
            bx, [=] AMREX_GPU_HOST_DEVICE(int i, int j, int k) noexcept {
                ...
                if (k == domlo[2] + 1 && lo_bc[2] != Interior) {
                    ...
                    // from the left physical boundary, MC Eq. 22
                    a_int(i, j, k) =
                        (1.0_rt / 12.0_rt) * (3.0_rt * a(i, j, k - 1, ncomp) +
                                              13.0_rt * a(i, j, k, ncomp) -
                                              5.0_rt * a(i, j, k + 1, ncomp) +
                                              a(i, j, k + 2, ncomp));
                    ...
                    a_int(i, j, k) =
                        (1.0_rt / 12.0_rt) * (25.0_rt * a(i, j, k, ncomp) -
                                              23.0_rt * a(i, j, k + 1, ncomp) +
                                              13.0_rt * a(i, j, k + 2, ncomp) -
                                              3.0_rt * a(i, j, k + 3, ncomp));
                    ...
                    a_int(i, j, k) =
                        (1.0_rt / 12.0_rt) * (3.0_rt * a(i, j, k, ncomp) +
                                              13.0_rt * a(i, j, k - 1, ncomp) -
                                              5.0_rt * a(i, j, k - 2, ncomp) +
                                              a(i, j, k - 3, ncomp));
                    ...
                    // right physical boundary MC Eq. 21
                    a_int(i, j, k) =
                        (1.0_rt / 12.0_rt) * (25.0_rt * a(i, j, k - 1, ncomp) -
                                              23.0_rt * a(i, j, k - 2, ncomp) +
                                              13.0_rt * a(i, j, k - 3, ncomp) -
                                              3.0_rt * a(i, j, k - 4, ncomp));

                } else if (k == domlo[2] - 1 && lo_bc[2] == Outflow) {
                    // extrapolate to the domlo[2]-1 cell using a
                    // conservative cubic polynomial averaged over
                    // the cell
                    Real ac = 4.0_rt * a(i, j, domlo[2], ncomp) -
                              6.0_rt * a(i, j, domlo[2] + 1, ncomp) +
                              4.0_rt * a(i, j, domlo[2] + 2, ncomp) -
                              a(i, j, domlo[2] + 3, ncomp);

                    // now use the 1-sided stencil from above with
                    // this extrapolated value
                    a_int(i, j, k) =
                        (1.0_rt / 12.0_rt) *
                        (25.0_rt * ac - 23.0_rt * a(i, j, k + 1, ncomp) +
                         13.0_rt * a(i, j, k + 2, ncomp) -
                         3.0_rt * a(i, j, k + 3, ncomp));
                    ...
                    // conservative cubic polynomial averaged over
                    // the cell
                    Real ac = 4.0_rt * a(i, j, domhi[2], ncomp) -
                              6.0_rt * a(i, j, domhi[2] - 1, ncomp) +
                              4.0_rt * a(i, j, domhi[2] - 2, ncomp) -
                              a(i, j, domhi[2] - 3, ncomp);

                    // now use the 1-sided stencil from above with
                    // this extrapolated value
                    a_int(i, j, k) =
                        (1.0_rt / 12.0_rt) *
                        (25.0_rt * ac - 23.0_rt * a(i, j, k - 2, ncomp) +
                         13.0_rt * a(i, j, k - 3, ncomp) -
                         3.0_rt * a(i, j, k - 4, ncomp));
                    ...
                    a_int(i, j, k) =
                        (7.0_rt / 12.0_rt) *
                            (a(i, j, k - 1, ncomp) + a(i, j, k, ncomp)) -
                        (1.0_rt / 12.0_rt) *
                            (a(i, j, k - 2, ncomp) + a(i, j, k + 1, ncomp));
                }
            });
    }
}

void Castro::states(const Box& bx, const int idir, const int ncomp,
                    Array4<Real const> const& a,
                    Array4<Real const> const& a_int,
                    Array4<Real const> const& flatn, Array4<Real> const& al,
    ...
    if (idir == 0) {
        ...
        if (limit_fourth_order == 0) {
            ...
            amrex::ParallelFor(bx, [=] AMREX_GPU_HOST_DEVICE(int i, int j,
                ...
                // these live on cell-centers
                Real d2af =
                    6.0_rt * (a_int(i, j, k) - 2.0_rt * a(i, j, k, ncomp) +
                              a_int(i + 1, j, k));

                Real d2acm2 = a(i - 3, j, k, ncomp) -
                              2.0_rt * a(i - 2, j, k, ncomp) +
                              a(i - 1, j, k, ncomp);
                Real d2acm1 = a(i - 2, j, k, ncomp) -
                              2.0_rt * a(i - 1, j, k, ncomp) +
                              a(i, j, k, ncomp);
                Real d2ac0 = a(i - 1, j, k, ncomp) -
                             2.0_rt * a(i, j, k, ncomp) + a(i + 1, j, k, ncomp);
                Real d2acp1 = a(i, j, k, ncomp) -
                              2.0_rt * a(i + 1, j, k, ncomp) +
                              a(i + 2, j, k, ncomp);
                Real d2acp2 = a(i + 1, j, k, ncomp) -
                              2.0_rt * a(i + 2, j, k, ncomp) +
                              a(i + 3, j, k, ncomp);

                // limit? MC Eq. 24 and 25
                if (dafm * dafp <= 0.0_rt ||
                    (a(i, j, k, ncomp) - a(i - 2, j, k, ncomp)) *
                            (a(i + 2, j, k, ncomp) - a(i, j, k, ncomp)) <=
                        0.0_rt) {
                    ...
                    if (s == std::copysign(1.0_rt, d2acm1) &&
                        ...
                        // MC Eq. 26
                        d2a_lim = s * amrex::min(std::abs(d2af),
                                                 C2 * std::abs(d2acm1),
                                                 C2 * std::abs(d2ac0),
                                                 C2 * std::abs(d2acp1));
                    } else {
                    ...
                    if (std::abs(d2af) <=
                        1.e-12_rt *
                            amrex::max(std::abs(a(i - 2, j, k, ncomp)),
                                       std::abs(a(i - 1, j, k, ncomp)),
                                       std::abs(a(i, j, k, ncomp)),
                                       std::abs(a(i + 1, j, k, ncomp)),
                    ...
                    if (rho < 1.0_rt - 1.e-12_rt) {
                        ...
                        if (C3 * amrex::max(std::abs(d3a_min),
                                            std::abs(d3a_max)) <=
                            (d3a_max - d3a_min)) {
                            // limit
                            if (dafm * dafp < 0.0_rt) {
                                ...
                                ar(i, j, k, ncomp) =
                                    a(i, j, k, ncomp) -
                                    rho * dafm;  // note: typo in Eq 29
                                al(i + 1, j, k, ncomp) =
                                    a(i, j, k, ncomp) + rho * dafp;
                            } else if (std::abs(dafm) >=
                                       2.0_rt * std::abs(dafp)) {
                                // Eq. 31
                                ar(i, j, k, ncomp) =
                                    a(i, j, k, ncomp) -
                                    2.0_rt * (1.0_rt - rho) * dafp - rho * dafm;
                            } else if (std::abs(dafp) >=
                                       2.0_rt * std::abs(dafm)) {
                                // Eq. 32
                                al(i + 1, j, k, ncomp) =
                                    a(i, j, k, ncomp) +
                                    2.0_rt * (1.0_rt - rho) * dafm + rho * dafp;
                            }
                        }
                    }
                ...
                al(i + 1, j, k, ncomp) =
                    flatn(i, j, k) * al(i + 1, j, k, ncomp) +
                    (1.0_rt - flatn(i, j, k)) * a(i, j, k, ncomp);
                ar(i, j, k, ncomp) =
                    flatn(i, j, k) * ar(i, j, k, ncomp) +
                    (1.0_rt - flatn(i, j, k)) * a(i, j, k, ncomp);
                ...
                if (i == domlo[0]) {
                    ...
                    if (lo_bc[0] == Outflow) {
                        ...
                        if (ncomp == QU) {
                            ...
                            al(domlo[0], j, k, ncomp) =
                                ar(domlo[0], j, k, ncomp);
                        }
                        ...
                        // not supported
                        amrex::Error(
                            "ERROR: boundary conditions not supported for -X "
                            "in states");
                    }
                }
                ...
                if (i == domhi[0] + 1) {
                    ...
                    if (hi_bc[0] == Outflow) {
                        ...
                        if (ncomp == QU) {
                            ...
                            ar(domhi[0] + 1, j, k, ncomp) =
                                al(domhi[0] + 1, j, k, ncomp);
                        }
        ...
        if (limit_fourth_order == 0) {
            ...
            amrex::ParallelFor(bx, [=] AMREX_GPU_HOST_DEVICE(int i, int j,
                ...
                Real d2acm2 = a(i, j - 3, k, ncomp) -
                              2.0_rt * a(i, j - 2, k, ncomp) +
                              a(i, j - 1, k, ncomp);
                Real d2acm1 = a(i, j - 2, k, ncomp) -
                              2.0_rt * a(i, j - 1, k, ncomp) +
                              a(i, j, k, ncomp);
                Real d2ac0 = a(i, j - 1, k, ncomp) -
                             2.0_rt * a(i, j, k, ncomp) + a(i, j + 1, k, ncomp);
                Real d2acp1 = a(i, j, k, ncomp) -
                              2.0_rt * a(i, j + 1, k, ncomp) +
                              a(i, j + 2, k, ncomp);
                Real d2acp2 = a(i, j + 1, k, ncomp) -
                              2.0_rt * a(i, j + 2, k, ncomp) +
                              a(i, j + 3, k, ncomp);

                // limit? MC Eq. 24 and 25
                if (dafm * dafp <= 0.0_rt ||
                    (a(i, j, k, ncomp) - a(i, j - 2, k, ncomp)) *
                            (a(i, j + 2, k, ncomp) - a(i, j, k, ncomp)) <=
                        0.0_rt) {
                    ...
                    if (std::abs(d2af) <=
                        1.e-12_rt *
                            amrex::max(std::abs(a(i, j - 2, k, ncomp)),
                                       std::abs(a(i, j - 1, k, ncomp)),
                                       std::abs(a(i, j, k, ncomp)),
                                       std::abs(a(i, j + 1, k, ncomp)),
                ...
                if (j == domlo[1]) {
                    ...
                    if (lo_bc[1] == Outflow) {
                        ...
                        if (ncomp == QV) {
                            ...
                            al(i, domlo[1], k, ncomp) =
                                ar(i, domlo[1], k, ncomp);
                        }
                        ...
                        // not supported
                        amrex::Error(
                            "ERROR: boundary conditions not supported for -Y "
                            "in states");
                    }
                }
                ...
                if (j == domhi[1] + 1) {
                    ...
                    if (hi_bc[1] == Outflow) {
                        ...
                        if (ncomp == QV) {
                            ...
                            ar(i, domhi[1] + 1, k, ncomp) =
                                al(i, domhi[1] + 1, k, ncomp);
                        }
        ...
        if (limit_fourth_order == 0) {
            ...
            amrex::ParallelFor(bx, [=] AMREX_GPU_HOST_DEVICE(int i, int j,
                ...
                Real d2acm2 = a(i, j, k - 3, ncomp) -
                              2.0_rt * a(i, j, k - 2, ncomp) +
                              a(i, j, k - 1, ncomp);
                Real d2acm1 = a(i, j, k - 2, ncomp) -
                              2.0_rt * a(i, j, k - 1, ncomp) +
                              a(i, j, k, ncomp);
                Real d2ac0 = a(i, j, k - 1, ncomp) -
                             2.0_rt * a(i, j, k, ncomp) + a(i, j, k + 1, ncomp);
                Real d2acp1 = a(i, j, k, ncomp) -
                              2.0_rt * a(i, j, k + 1, ncomp) +
                              a(i, j, k + 2, ncomp);
                Real d2acp2 = a(i, j, k + 1, ncomp) -
                              2.0_rt * a(i, j, k + 2, ncomp) +
                              a(i, j, k + 3, ncomp);

                // limit? MC Eq. 24 and 25
                if (dafm * dafp <= 0.0_rt ||
                    (a(i, j, k, ncomp) - a(i, j, k - 2, ncomp)) *
                            (a(i, j, k + 2, ncomp) - a(i, j, k, ncomp)) <=
                        0.0_rt) {
                    ...
                    if (std::abs(d2af) <=
                        1.e-12_rt *
                            amrex::max(std::abs(a(i, j, k - 2, ncomp)),
                                       std::abs(a(i, j, k - 1, ncomp)),
                                       std::abs(a(i, j, k, ncomp)),
                                       std::abs(a(i, j, k + 1, ncomp)),
                ...
                if (k == domlo[2]) {
                    ...
                    if (lo_bc[2] == Outflow) {
                        ...
                        if (ncomp == QW) {
                            ...
                            al(i, j, domlo[2], ncomp) =
                                ar(i, j, domlo[2], ncomp);
                        }
                        ...
                        // not supported
                        amrex::Error(
                            "ERROR: boundary conditions not supported for -Z "
                            "in states");
                    }
                }
                ...
                if (k == domhi[2] + 1) {
                    ...
                    if (hi_bc[2] == Outflow) {
                        ...
                        if (ncomp == QW) {
                            ...
                            ar(i, j, domhi[2] + 1, ncomp) =
                                al(i, j, domhi[2] + 1, ncomp);
                        }
...
void Castro::fourth_avisc(const Box& bx, Array4<Real const> const& q,
                          Array4<Real const> const& qaux,
                          Array4<Real> const& avis, const int idir) {
    ...
    amrex::ParallelFor(
        bx, [=] AMREX_GPU_HOST_DEVICE(int i, int j, int k) noexcept {
            ...
            Real coeff = amrex::min(1.0_rt, (dx[idir] * avis(i, j, k)) *
                                                (dx[idir] * avis(i, j, k)) /
                                                (beta * (cmin * cmin)));
...
#ifdef DIFFUSION
void Castro::fourth_add_diffusive_flux(const Box& bx,
                                       Array4<Real const> const& q,
                                       const int temp_comp,
                                       Array4<Real const> const& qint,
                                       Array4<Real> const& F, const int idir,
                                       const bool is_avg) {
    ...
    amrex::ParallelFor(bx, [=] AMREX_GPU_HOST_DEVICE(int i, int j,
        ...
        if (idir == 0) {
            ...
            if (is_avg) {
                ...
                dTdx =
                    (-q(i + 1, j, k, temp_comp) + 27 * q(i, j, k, temp_comp) -
                     27 * q(i - 1, j, k, temp_comp) +
                     q(i - 2, j, k, temp_comp)) /
                    (24.0_rt * dx[0]);
                ...
                dTdx =
                    (-q(i + 1, j, k, temp_comp) + 15 * q(i, j, k, temp_comp) -
                     15 * q(i - 1, j, k, temp_comp) +
                     q(i - 2, j, k, temp_comp)) /
                    (12.0_rt * dx[0]);
            }
            ...
            if (is_avg) {
                // we are working with the cell-center state
                dTdx =
                    (-q(i, j + 1, k, temp_comp) + 27 * q(i, j, k, temp_comp) -
                     27 * q(i, j - 1, k, temp_comp) +
                     q(i, j - 2, k, temp_comp)) /
                    (24.0_rt * dx[1]);
                ...
                // we are working with the cell-average state
                dTdx =
                    (-q(i, j + 1, k, temp_comp) + 15 * q(i, j, k, temp_comp) -
                     15 * q(i, j - 1, k, temp_comp) +
                     q(i, j - 2, k, temp_comp)) /
                    (12.0_rt * dx[1]);
            }
            ...
            if (is_avg) {
                // we are working with the cell-center state
                dTdx =
                    (-q(i, j, k + 1, temp_comp) + 27 * q(i, j, k, temp_comp) -
                     27 * q(i, j, k - 1, temp_comp) +
                     q(i, j, k - 2, temp_comp)) /
                    (24.0_rt * dx[2]);
                ...
                // we are working with the cell-average state
                dTdx =
                    (-q(i, j, k + 1, temp_comp) + 15 * q(i, j, k, temp_comp) -
                     15 * q(i, j, k - 1, temp_comp) +
                     q(i, j, k - 2, temp_comp)) /
                    (12.0_rt * dx[2]);
            }
        }
