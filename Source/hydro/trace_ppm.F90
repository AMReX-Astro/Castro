          ...
          do i = lo(1)-1, hi(1)+1
             ...
             if ((idir == 1 .and. i >= lo(1)) .or. &
                ...
                if (ppm_temp_fix < 3) then
                   ...
                   if (ppm_predict_gammae == 0) then
                      ...
                      qp(i,j,k,QPRES ) =    p_ref + (alphap + alpham)*csq_ev
                      ...
                      qp(i,j,k,QPRES ) = p_ref - (alphap + alpham)*Clag_ev**2
             ...
             if ((idir == 1 .and. i <= hi(1)) .or. &
                ...
                if (ppm_temp_fix < 3) then
                   ...
                   if (ppm_predict_gammae == 0) then
                      qm(i+ix,j+iy,k+iz,QRHO  ) =  rho_ref +  alphap + alpham + alpha0r
                      ...
                      qm(i+ix,j+iy,k+iz,QPRES ) =    p_ref + (alphap + alpham)*csq_ev
                   else
                      tau_s = tau_ref + alphap + alpham + alpha0r
                      qm(i+ix,j+iy,k+iz,QRHO  ) = ONE/tau_s

                      qm(i+ix,j+iy,k+iz,QUN   ) = un_ref + (alpham - alphap)*Clag_ev
                      qm(i+ix,j+iy,k+iz,QPRES ) = p_ref - (alphap + alpham)*Clag_ev**2
