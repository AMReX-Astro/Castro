...
#endif
	                        is_new, S_new, old_source, dt, S_new.nGrow());
   ...
   // since the hydro source only works on the valid zones.
    ...
    if (apply_sources()) {
      ...
      apply_source_to_state(
                            ...
                            Bx_new, By_new, Bz_new,
#endif 
    			    is_new, S_new, new_source, dt, S_new.nGrow());
