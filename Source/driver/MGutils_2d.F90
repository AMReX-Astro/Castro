...
contains
  ...
  subroutine ca_apply_metric(lo, hi, &
    ...
    integer,  intent(in   ) :: xlo(2), xhi(2)
    integer,  intent(in   ) :: ylo(2), yhi(2)
    ...
    real(rt), intent(inout) :: ecx(ecxl1:ecxh1,ecxl2:ecxh2)
    real(rt), intent(inout) :: ecy(ecyl1:ecyh1,ecyl2:ecyh2)
