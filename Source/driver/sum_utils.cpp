...
Real Castro::volWgtSum(const std::string& name, Real time, bool local,
                       bool finemask) {
...
Real Castro::locWgtSum(const std::string& name, Real time, int idir,
                       bool local) {
...
Real Castro::volProductSum(const std::string& name1, const std::string& name2,
...
Real Castro::locSquaredSum(const std::string& name, Real time, int idir,
                           bool local) {
