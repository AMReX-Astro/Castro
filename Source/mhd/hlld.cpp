...
void Castro::hlld(const Box& bx, Array4<Real const> const& qleft,
                  Array4<Real const> const& qright, Array4<Real> const& flx,
                  const int dir) {
    ...
    amrex::ParallelFor(bx, [=] AMREX_GPU_HOST_DEVICE(int i, int j,
        ...
        Real BR2 = qR(QMAGX) * qR(QMAGX) + qR(QMAGY) * qR(QMAGY) +
                   qR(QMAGZ) * qR(QMAGZ);
        ...
        FR(UMN) = qR(QRHO) * qR(QVELN) * qR(QVELN) +
                  (qR(QPRES) + 0.5_rt * BR2) - qR(QMAGN) * qR(QMAGN);
        FR(UMP1) = qR(QRHO) * qR(QVELN) * qR(QVELP1) - qR(QMAGN) * qR(QMAGP1);
        FR(UMP2) = qR(QRHO) * qR(QVELN) * qR(QVELP2) - qR(QMAGN) * qR(QMAGP2);
        FR(UEDEN) = qR(QVELN) * (uR(UEDEN) + (qR(QPRES) + 0.5_rt * BR2)) -
                    qR(QMAGN) * UBR;
        FR(UMAGN) = 0.0;
        ...
        Real cfL2 = std::sqrt(
            0.5_rt * ((asL + caL) + std::sqrt((asL + caL) * (asL + caL) -
                                              4.0_rt * asL * canL)));
        Real cfR = std::sqrt(
            0.5_rt * ((asR + caR) + std::sqrt((asR + caR) * (asR + caR) -
                                              4.0_rt * asR * canR)));
        ...
        Real sM = ((sR - qR(QVELN)) * qR(QRHO) * qR(QVELN) -
                   (sL - qL(QVELN)) * qL(QRHO) * qL(QVELN) -
        ...
        Real pst = (sR - qR(QVELN)) * qR(QRHO) * ptL -
                   (sL - qL(QVELN)) * qL(QRHO) * ptR +
                   qL(QRHO) * qR(QRHO) * (sR - qR(QVELN)) * (sL - qL(QVELN)) *
                       (qR(QVELN) - qL(QVELN));
        ...
        UsL(URHO) =
            amrex::max(small_dens, qL(QRHO) * ((sL - qL(QVELN)) / (sL - sM)));
        UsR(URHO) =
            amrex::max(small_dens, qR(QRHO) * ((sR - qR(QVELN)) / (sR - sM)));
        ...
        if (std::abs(qL(QMAGN) * qL(QMAGP1) * (sM - qL(QVELN))) < 1.e-14_rt) {
            ...
            UsL(UMP1) =
                qL(QVELP1) - qL(QMAGN) * qL(QMAGP1) *
                                 ((sM - qL(QVELN)) /
                                  (qL(QRHO) * (sL - qL(QVELN)) * (sL - sM) -
                                   qL(QMAGN) * qL(QMAGN)));
        }
        ...
        if (std::abs(qR(QMAGN) * qR(QMAGP1) * (sM - qR(QVELN))) < 1.e-14_rt) {
            ...
            UsR(UMP1) =
                qR(QVELP1) - qR(QMAGN) * qR(QMAGP1) *
                                 ((sM - qR(QVELN)) /
                                  (qR(QRHO) * (sR - qR(QVELN)) * (sR - sM) -
                                   qR(QMAGN) * qR(QMAGN)));
        }
        ...
        if (std::abs(qL(QMAGP1) *
                     (qL(QRHO) * (sL - qL(QVELN)) * (sL - qL(QVELN)) -
                      qL(QMAGN) * qL(QMAGN))) < 1.e-14_rt) {
        ...
        if (std::abs(qR(QMAGP1) *
                     (qR(QRHO) * (sR - qR(QVELN)) * (sR - qR(QVELN)) -
                      qL(QMAGN) * qL(QMAGN))) < 1.e-14_rt) {
        ...
        if (std::abs(qR(QMAGP2) *
                     (qR(QRHO) * (sR - qR(QVELN)) * (sR - qR(QVELN)) -
                      qR(QMAGN) * qR(QMAGN))) < 1.e-14_rt) {
        ...
        UsL(UEDEN) =
            (sL - qL(QVELN)) * uL(UEDEN) - ptL * qL(QVELN) + pst * sM +
            qL(QMAGN) * (UBL - (UsL(UMX) * UsL(UMAGX) + UsL(UMY) * UsL(UMAGY) +
                                UsL(UMZ) * UsL(UMAGZ)) /
                                   UsL(URHO));
        UsL(UEDEN) = UsL(UEDEN) / (sL - sM);

        UsR(UEDEN) =
            (sR - qR(QVELN)) * uR(UEDEN) - ptR * qR(QVELN) + pst * sM +
            qR(QMAGN) * (UBR - (UsR(UMX) * UsR(UMAGX) + UsR(UMY) * UsR(UMAGY) +
                                UsR(UMZ) * UsR(UMAGZ)) /
                                   UsR(URHO));
        ...
        UssL(UMP1) =
            (std::sqrt(UsL(URHO)) * UsL(UMP1) / UsL(URHO) +
        ...
        UssL(UMP2) =
            (std::sqrt(UsL(URHO)) * UsL(UMP2) / UsL(URHO) +
        ...
        UssL(UMAGP1) = (std::sqrt(UsL(URHO)) * UsR(UMAGP1) +
                        std::sqrt(UsR(URHO)) * UsL(UMAGP1) +
                        std::sqrt(UsL(URHO) * UsR(URHO)) *
                            (UsR(UMP1) / UsR(URHO) - UsL(UMP1) / UsL(URHO)) *
        ...
        UssL(UMAGP2) = (std::sqrt(UsL(URHO)) * UsR(UMAGP2) +
                        std::sqrt(UsR(URHO)) * UsL(UMAGP2) +
                        std::sqrt(UsL(URHO) * UsR(URHO)) *
                            (UsR(UMP2) / UsR(URHO) - UsL(UMP2) / UsL(URHO)) *
                            std::copysign(1.0_rt, qL(QMAGN))) /
                       (std::sqrt(UsL(URHO)) + std::sqrt(UsR(URHO)));
        ...
        UssL(UEDEN) = UsL(UEDEN) -
                      std::sqrt(UsL(URHO)) *
                          ((UsL(UMX) * UsL(UMAGX) + UsL(UMY) * UsL(UMAGY) +
                            UsL(UMZ) * UsL(UMAGZ)) /
                               UsL(URHO) -
                           (UssL(UMX) * UssL(UMAGX) + UssL(UMY) * UssL(UMAGY) +
                            UssL(UMZ) * UssL(UMAGZ)) /
                               UssL(URHO)) *
                          std::copysign(1.0_rt, qL(QMAGN));
        UssR(UEDEN) = UsR(UEDEN) +
                      std::sqrt(UsR(QRHO)) *
                          ((UsR(UMX) * UsR(UMAGX) + UsR(UMY) * UsR(UMAGY) +
                            UsR(UMZ) * UsR(UMAGZ)) /
                               UsR(URHO) -
                           (UssR(UMX) * UssR(UMAGX) + UssR(UMY) * UssR(UMAGY) +
                            UssR(UMZ) * UssR(UMAGZ)) /
                               UssR(URHO)) *
        ...
        if (sL > 0.0) {
            ...
            for (int n = 0; n < NUM_STATE + 3; n++) {
                flx(i, j, k, n) =
                    FL(n) + ssL * UssL(n) - (ssL - sL) * UsL(n) - sL * uL(n);
            }
            ...
            for (int n = 0; n < NUM_STATE + 3; n++) {
                flx(i, j, k, n) =
                    FR(n) + ssR * UssR(n) - (ssR - sR) * UsR(n) - sR * uR(n);
            }
