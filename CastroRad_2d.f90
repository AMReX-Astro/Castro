subroutine ca_umdrv_rad(is_finest_level,time,&
  ...
  allocate(     q(uin_l1:uin_h1,uin_l2:uin_h2,QRADVAR))
  allocate(  gamc(uin_l1:uin_h1,uin_l2:uin_h2))
  allocate( gamcg(uin_l1:uin_h1,uin_l2:uin_h2))
  allocate( flatn(uin_l1:uin_h1,uin_l2:uin_h2))
  allocate(     c(uin_l1:uin_h1,uin_l2:uin_h2))
  allocate(    cg(uin_l1:uin_h1,uin_l2:uin_h2))
  ...
  call ctoprim_rad(lo,hi,uin,uin_l1,uin_l2,uin_h1,uin_h2, &
       Erin,Erin_l1,Erin_l2,Erin_h1,Erin_h2, &
       lam,lam_l1,lam_l2,lam_h1,lam_h2, &
       q,c,cg,gamc,gamcg,csml,flatn,uin_l1,uin_l2,uin_h1,uin_h2, &
       src,srcQ,src_l1,src_l2,src_h1,src_h2, &
       courno,dx,dy,dt,ngq,ngf,iflaten)

!     Compute hyperbolic fluxes using unsplit Godunov
  call umeth2d_rad(q,c,cg,gamc,gamcg,csml,flatn,uin_l1,uin_l2,uin_h1,uin_h2, &
       lam, lam_l1,lam_l2,lam_h1,lam_h2, &
...
subroutine ca_get_v_dcf( &
  ...
  double precision, intent(out) ::   v(  v_l1:  v_h1,   v_l2:  v_h2, 2)
  double precision, intent(out) :: dcf(dcf_l1:dcf_h1, dcf_l2:dcf_h2)
...
subroutine ca_compute_dcoefs(d, d_l1, d_l2, d_h1, d_h2, &
  ...
  double precision, intent(out) ::   d(  d_l1:  d_h1,   d_l2:  d_h2)
...
subroutine ca_update_dcf(dcf, dcf_l1, dcf_l2, dcf_h1, dcf_h2, &
...
subroutine ca_set_dterm_face(Er, Er_l1, Er_l2, Er_h1, Er_h2, &
  ...
  double precision, intent(out) :: dtf(dtf_l1:dtf_h1,dtf_l2:dtf_h2)
  integer :: i, j
...
subroutine ca_face2center(foox, foox_l1, foox_l2, foox_h1, foox_h2, &
  ...
  double precision, intent(out) :: fooc(fooc_l1:fooc_h1,fooc_l2:fooc_h2)
