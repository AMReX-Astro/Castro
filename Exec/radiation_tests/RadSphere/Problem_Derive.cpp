...
void ca_deranalytic(Real* der, const int* der_lo, const int* der_hi,
    ...
    deranalytic(der, AMREX_ARLIM_ANYD(der_lo), AMREX_ARLIM_ANYD(der_hi), *nvar,
                data, AMREX_ARLIM_ANYD(data_lo), AMREX_ARLIM_ANYD(data_hi),
                *ncomp, AMREX_ARLIM_ANYD(lo), AMREX_ARLIM_ANYD(hi),
