...
DIM=1
EXEC=./Castro${DIM}d.pgi.CUDA.SMPLSDC.ex

RUNPARAMS="castro.time_integration_method=3 amr.blocking_factor=8"

${EXEC} inputs.64 ${RUNPARAMS} &> 64.out
${EXEC} inputs.128 ${RUNPARAMS} &> 128.out
${EXEC} inputs.256 ${RUNPARAMS} &> 256.out
...
${EXEC} inputs.512 ${RUNPARAMS} &> 512.out
