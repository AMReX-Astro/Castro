...
mpiexec -n 16 ./Castro2d.gnu.MPI.ex inputs.256 castro.sdc_order=2 castro.time_integration_method=2
...
mpiexec -n 16 ./Castro2d.gnu.MPI.ex inputs.512 castro.sdc_order=2 castro.time_integration_method=2
