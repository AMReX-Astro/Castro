...
mpiexec -n 8 ${EXEC} inputs.3d.64 ${RUNPARAMS} amr.plot_file=acoustic_pulse_64_ppm_plt &> 64.out
mpiexec -n 8 ${EXEC} inputs.3d.128 ${RUNPARAMS} amr.plot_file=acoustic_pulse_128_ppm_plt &> 128.out
mpiexec -n 8 ${EXEC} inputs.3d.256 ${RUNPARAMS} amr.plot_file=acoustic_pulse_256_ppm_plt &> 256.out
...
#mpiexec -n 4 ${EXEC} inputs.2d.512 ${RUNPARAMS} amr.plot_file=acoustic_pulse_512_ppm_plt &> 512.out
