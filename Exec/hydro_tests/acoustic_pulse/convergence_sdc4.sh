...
RichardsonConvergenceTest${DIM}d.gnu.ex coarFile=acoustic_pulse_64_plt00081 mediFile=acoustic_pulse_128_plt00161 fineFile=acoustic_pulse_256_plt00321 > convergence.${DIM}d.lo.sdc4.out
RichardsonConvergenceTest${DIM}d.gnu.ex coarFile=acoustic_pulse_128_plt00161 mediFile=acoustic_pulse_256_plt00321 fineFile=acoustic_pulse_512_plt00641 > convergence.${DIM}d.hi.sdc4.out
