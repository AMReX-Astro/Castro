  ...
  do k = lo(3), hi(3)
     do j = lo(2), hi(2)
        ...
        do i = lo(1), hi(1)
           ...
           state(i,j,k,URHO)  = interpolate(y,npts_model,model_r, &
                                            model_state(:,idens_model))
           state(i,j,k,UTEMP) = interpolate(y,npts_model,model_r, &
                                            model_state(:,itemp_model))
           do n = 1, nspec
              state(i,j,k,UFS-1+n) = interpolate(y,npts_model,model_r, &
