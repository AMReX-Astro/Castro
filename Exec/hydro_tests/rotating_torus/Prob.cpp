...
Real Castro::compute_moment_of_inertia() {
...
void Castro::problem_post_init() {
    ...
    amrex::Print() << std::endl
                   << "  Moment of inertia = " << initial_moment_of_inertia
                   << std::endl;
}
...
void Castro::problem_post_timestep() {
    ...
    amrex::Print() << std::endl
                   ...
                   << std::endl;
    amrex::Print() << std::endl
                   << "  Moment of inertia / initial moment of inertia = "
                   << moment_of_inertia / initial_moment_of_inertia
                   << std::endl;
}
