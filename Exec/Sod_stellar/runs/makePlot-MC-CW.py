...
def model():
    ...
    for p in problems:
        ...
        print "saving figure: %s-MC-CW.png" % (p)
        pylab.savefig("%s-MC-CW.png" % (p))
        pylab.savefig("%s-MC-CW.eps" % (p))
        ...
        print "saving figure: %s-MC-CW-resid.png" % (p)
        pylab.savefig("%s-MC-CW-resid.png" % (p))
