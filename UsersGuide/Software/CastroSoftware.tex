...
\end{lstlisting}
  ...
  \item the {\tt *fill} routines:
    ...
    setups won't need to do anything special here.

    The idea is that these routines are registered in {\tt
      Castro\_setup.cpp}, and called as needed.  By default, they just
