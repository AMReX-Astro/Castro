...
frequency (in Hz) is specified by setting {\bf
  castro.rotational\_frequency} in the inputs file.  Note that this
...
frequency specified by {\bf castro.rotational\_frequency} is internally
converted to an angular freqeuncy for use in the source term
equations.
