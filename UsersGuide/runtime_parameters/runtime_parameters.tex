...
\rowcolor{tableShade}
\verb=  dtnuc_f2  = &   limit the timestep based on whether the burning can change the internal energy of a zone. The timestep is equal to {\tt dtnuc\_f2} $(e / de/dt) (\Delta t_{\rm{old}} / t_s)$, where $t_s$ is the sound-crossing time $\Delta x / c_s$ and $\Delta t_{\rm{old}}$ is the last burning timestep  &  1.e200 \\
