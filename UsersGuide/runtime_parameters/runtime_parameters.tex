...
\verb=  dsnuc  = &   limit the timestep based on how much the burning can change the mass fractions of the species in a one. The timestep for a given species $k$ is equal to {\tt dsnuc} $\cdot\, (X_k / \dot{X_k})$  &  1.e200 \\
\rowcolor{tableShade}
\verb=  dtnuc  = &   limit the timestep based on how much the burning can change the internal energy of a zone. The timestep is equal to {\tt dtnuc}  $\cdot\,(e / \dot{e})$  &  1.e200 \\
