...
\verb=  dtnuc_f1  = &   limit the timestep based on how much the burning can change the internal energy of a zone. The timestep is equal to {\tt dtnuc\_f1}  $(e / de/dt)$  &  1.e200 \\
\rowcolor{tableShade}
\verb=  dtnuc_f2  = &   limit the timestep based on whether the burning can change the internal energy of a zone. The timestep is equal to [{\tt dtnuc\_f2} $(e / (de/dt \cdot \Delta t_{\rm{old}})) (1 / t_s)]^{-1}$, where $t_s$ is the sound-crossing time $\Delta x / c_s$ and $\Delta t_{\rm{old}}$ is the last burning timestep  &  1.e200 \\
