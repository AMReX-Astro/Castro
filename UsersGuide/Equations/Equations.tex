...
total gas energy, making the subtraction numerically unreliable; two, if you use gravity or
...
otherwise, we use $e$ (note that this convention for reactions is reversed from the hydro version).
...
\item {\tt riemann\_solver}: this can be one of the following values:
  \begin{itemize}
    ...
    \item {\tt 2}: the HLLC solver.  Note: this should only be used in 3-d
      at the moment.
  \end{itemize}
