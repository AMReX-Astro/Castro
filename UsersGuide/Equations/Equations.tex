...
\castro\ has two main options for the Riemann solver---the
Colella \& Glaz solver~\cite{colglaz} (the same solver used
by Flash) and a simpler solver described in an unpublished
manuscript by Colella, Glaz, \& Ferguson.  These are both
