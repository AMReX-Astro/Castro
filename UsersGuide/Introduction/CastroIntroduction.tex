...
Past and present contributors to the \castro\ code base include: % git shortlog -s -n
\begin{quote}
Ann Almgren\newline
John Bell\newline
Vince Beckner\newline
...
External contributions are welcomed.  Fork the \castro\ repo, modify your local copy, and issue
a pull-request to the {\tt BoxLib-Codes/Castro} project.
