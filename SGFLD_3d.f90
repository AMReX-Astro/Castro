...
subroutine ca_test_type_lambda(  &
  ...
  double precision, intent(inout) :: test(test_l1:test_h1,test_l2:test_h2,test_l3:test_h3,ntest)
  integer :: i,j,k

  do k = test_l3, test_h3
...
subroutine ca_test_type_flux_lab( &
  ...
  double precision,intent(inout)::flab(fl_l1:fl_h1,fl_l2:fl_h2,fl_l3:fl_h3,0:nt-1)
