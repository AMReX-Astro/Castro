...
\item \label{strang:newsource} {\em Correct the source terms with the $n+1$ contribution}
  ...
  in the \variable{new\_source} \multifab\footnote{The correction for gravity is slightly different since we directly compute the time-centered gravitational source term using the hydrodynamic fluxes.}.
