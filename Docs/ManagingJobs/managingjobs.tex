...
\item It seems that setting
\begin{verbatim}
IPA_DISABLE_DISCARDING=1
\end{verbatim}
when compiling, it will work around the bug.
\end{itemize}
...
\item Cray compilers
  ...
  \begin{itemize}
    ...
    \item The Cray compilers from versions 8.5.7 to 8.6.4 have issues compiling AMReX. This
    can be resolved by loading version 8.6.5 or later. As of May 2018, you can do
    \begin{verbatim}
