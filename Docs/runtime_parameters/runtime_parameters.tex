...
\runparamNS{timestamp\_density}{castro} &  whether the local densities at given positions of particles are stored in output files & 1 \\
\rowcolor{tableShade}
\runparamNS{timestamp\_temperature}{castro} &  whether the local temperatures at given positions of particles are stored in output files & 0 \\
