...
\runparamNS{mhd\_plm\_slope}{castro} &  plm slopes: 0 zero slope 1 vanleer 2 centered, no limit & 1 \\
\rowcolor{tableShade}
...
\rowcolor{tableShade}
\runparamNS{ppm\_flatten\_before\_integrals}{castro} &  & 1 \\
...
\rowcolor{tableShade}
\runparamNS{ppm\_reference}{castro} & MHD & 1 \\
...
\runparamNS{max\_dxnuc\_lev}{castro} &  Disable limiting based on dxnuc above this AMR level. & -1 \\
\rowcolor{tableShade}
