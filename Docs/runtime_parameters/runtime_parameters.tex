...
\rowcolor{tableShade}
\runparamNS{reflux\_strategy}{castro} &  refluxing strategy. Ordered in descending level of accuracy and descending computational expense. 1 = reflux during every finest level timestep 2 = reflux at the end of every timestep on every level & 1 \\
...
\runparamNS{max\_multipole\_moment\_level}{gravity} &  For multipole gravity calculations, this is the maximum level used for constructing the multipole moments. & 0 \\
\rowcolor{tableShade}
