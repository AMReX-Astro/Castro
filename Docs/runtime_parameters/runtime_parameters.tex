...
\rowcolor{tableShade}
\runparamNS{sdc\_solver}{castro} &  which SDC nonlinear solver to use?  1 = Newton, 2 = Powell & 1 \\
\runparamNS{sdc\_solver\_tol}{castro} &  which SDC nonlinear solver to use?  1 = Newton, 2 = Powell & 1.e-12 \\
\rowcolor{tableShade}
