...
\runparamNS{sdc\_solver}{castro} &  which SDC nonlinear solver to use?  1 = Newton, 2 = VODE & 1 \\
\rowcolor{tableShade}
\runparamNS{sdc\_solver\_tol}{castro} &  which SDC nonlinear solver to use?  1 = Newton, 2 = Powell & 1.e-6 \\
