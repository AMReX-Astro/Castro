...
\item (optional) Two additional repositories, {\tt Microphysics.git}
  and {\tt CastroRadiation.git} are available at the {\tt
    BoxLib-Codes} github page.  These add additional reaction
  networks/EOSes and radiation, respectively, and can be cloned
...
and
\begin{verbatim}
git clone ssh://git@github.com:/BoxLib-Codes/CastroRadiation.git
\end{verbatim}
