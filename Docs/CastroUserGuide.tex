...
\graphicspath{{CastroVerification/}{Software/}{ConvertCheckpoint/}{Scaling/}{Visualization/}}
...
\newcommand{\runparamc}[1]{\index{Runtime parameters!{\tt castro.#1}}{\tt #1}}
...
\input Introduction/CastroIntroduction.tex
...
\bibliography{refs,CastroVerification/verification,Gravity/gr,LevelSet/levelset}
