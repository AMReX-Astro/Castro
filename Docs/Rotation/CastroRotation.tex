...
\item {\tt castro.rotation\_include\_centrifugal} : whether to include the centrifugal
  forcing (default: 1)

\item {\tt castro.rotation\_include\_coriolis} : whether to include the Coriolis
  forcing (default: 1)

\item {\tt castro.rotation\_include\_domegadt} : whether to include the forcing
  from the time derivative of the rotation frequency (default: 1)

\item {\tt castro.state\_in\_rotating\_frame} : whether state variables are measured
  in the rotating frame (default: 1)

\item {\tt castro.rot\_source\_type} : method of updating the energy during a rotation
  update (default: 4)

\item {\tt castro.implicit\_rotation\_update} : for the Coriolis term, which mixes
  momenta in the source term, whether we should solve for the update implicitly (default: 1)

\item {\tt castro.rot\_axis} : rotation axis (default: 3 (Cartesian); 2 (cylindrical))
