...
subroutine ca_test_type_lambda(test, test_l1, test_l2, test_h1, test_h2, ntest, n, &
     lamx, lamx_l1, lamx_l2, lamx_h1, lamx_h2, &
     lamy, lamy_l1, lamy_l2, lamy_h1, lamy_h2)

  implicit none

  integer, intent(in) :: test_l1, test_l2, test_h1, test_h2, ntest, n, &
  ...
  double precision, intent(inout) :: test(test_l1:test_h1,test_l2:test_h2,ntest)
  integer :: i,j

  do j = test_l2, test_h2
...
subroutine ca_test_type_flux_lab( &
  ...
  double precision,intent(inout)::flab(fl_l1:fl_h1,fl_l2:fl_h2,0:nt-1)
